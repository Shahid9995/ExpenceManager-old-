...
class AppConstants {
  static const String APP_NAME = 'Expense Manager';
  static const double APP_VE45RSION = 5.7;

  static const String BASE_URL = 'http://shanzycollection.com/expense_manager/public';
  static const String LOGIN_URI = '/api/login';
  static const String SIGNUP_URI = '/api/signup';
  static const String VERIFYDATA_URI = '/api/verify-data';
  static const String UPDATEPROFILE_URI = '/api/update-profile';
  static const String USERDATA_URI = '/api/user-data/';
  static const String TRANSTYPE_URI = '/api/get-transaction-types';
  static const String TRANSSAVE_URI = '/api/save-transaction';
  static const String SAVERECEIPT_URI = '/api/save-receipt';
  static const String SAVEPRODUCT_URI = '/api/save-price-lookup';
  static const String VerficationCode_URI = '/api/verify-data';
  static const String SaveCard_URI = '/api/save-card';
  static const String ChangePasswor_URI = '/api/change-password';
  static const String GoogleSearch_URI = '/api/custom-search';
  static const String DeleteReciept_URI = '/api/delete-transaction/';
  static const String DeleteCARD_URI = '/api/delete-card/';
  ...
  static const String PRICEALERT = "0";
  static const String new_transaction_alert = "0";
  static const String transaction_alert = "false";
  static const String TodaySpent = 'today_spent';
  static const String KEY_LOCAL_AUTH_ENABLED ="false";
