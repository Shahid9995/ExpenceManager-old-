...
class MonthScreen extends StatefulWidget {
  ...
  final List<Month>? dataModel;
  const MonthScreen({Key? key,required this.heading,required this.dataModel}) : super(key: key);
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text("${MyRepo.userDataModel.value.data!.monthSpent}",style:poppinsMedium.copyWith(fontSize:AppSizes.appHorizontalMd*1.2),)
                          ],
                        ),
                        Text("This Month",style:poppinsLight.copyWith(fontSize: AppSizes.appHorizontalSm*1.3),),
                      ],
                    ),
                  ),
                ),
