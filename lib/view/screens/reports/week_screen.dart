...
class WeekScreen extends StatefulWidget {
  ...
  final List<Week>? dataModel;
  const WeekScreen({Key? key,required this.heading,required this.dataModel}) : super(key: key);
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text("${MyRepo.userDataModel.value.data!.weekSpent}",style:poppinsMedium.copyWith(fontSize:AppSizes.appHorizontalMd*1.2),)
                          ],
                        ),
                        Text("This Week",style:poppinsLight.copyWith(fontSize: AppSizes.appHorizontalSm*1.3),),
                      ],
                    ),
                  ),
                ),
                  ...
                  children: [
                    Padding(
                      ...
                      child: ProgressBar(
                        ...
                        current: MyRepo.userDataModel.value.data!.reports!.week![index].transactionAmount.toDouble(),
                        max:(MyRepo.userDataModel.value.data!.weekSpent.toDouble()==0)?1:MyRepo.userDataModel.value.data!.weekSpent.toDouble(),),
                    ),
                    // SizedBox(
